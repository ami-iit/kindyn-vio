                             ...
                             const iDynTree::Position& prf0)
{
    ...
    sensdev_handler->setParameter("swing_foot_angular_velocity_noise_std_dev",
                                  std::vector<double>{0.015, 0.015, 0.015});
    ...
    initstate_handler->setParameter("imu_orientation_quaternion_wxyz",
                                    std::vector<double>{R0.asQuaternion()(0),
                                                        R0.asQuaternion()(1),
                                                        R0.asQuaternion()(2),
                                                        R0.asQuaternion()(3)});
    initstate_handler->setParameter("imu_position_xyz", std::vector<double>{p0(0), p0(1), p0(2)});
    ...
    prior_handler->setParameter("imu_orientation",
                                std::vector<double>{deg2rad(0.1), deg2rad(0.1), deg2rad(0.1)});
    prior_handler->setParameter("imu_position", std::vector<double>{1e-3, 1e-3, 1e-3});
    prior_handler->setParameter("imu_linear_velocity", std::vector<double>{1e-2, 1e-2, 1e-2});
    prior_handler->setParameter("accelerometer_bias", std::vector<double>{1e-1, 1e-1, 1e-1});
    prior_handler->setParameter("gyroscope_bias", std::vector<double>{1e-1, 1e1, 1e-1});
...
TEST_CASE("Invariant EKF Base Estimator + iSAM2 Fixed Lag Smoothing")
{
    ...
    auto filter = std::make_unique<InvariantEKFBaseEstimator>();
